...
main_menu() {
    ...
    echo "1) Download VSCode"
    echo "2) Download Brave Browser"
    echo "3) Download Firefox"
    echo "4) Download Thunderbird"
    echo "5) Download Google Chrome"
    echo "6) Download LibreOffice"
    echo "7) Download GIMP"
    echo "8) Download Minecraft"
    echo "9) Exit"
...
while true; do
    ...
    case $choice in
        ...
        2) download_brave ;;
        3) download_firefox ;;
        4) download_thunderbird ;;
        5) download_chrome ;;
        6) download_libreoffice ;;
        7) download_gimp ;;
        8) download_minecraft ;;
